...
function getTimeRemaining(endtime) {
    ...
    var when = endtime.getTime() > (new Date()).getTime() ? 'in ' : 'da ';
    return {
        'total': t,
        'days': days,
        'hours': hours,
...
function initializeClock(id, endtime) {
    ...
    function updateClock() {
        ...
        daysSpan.innerHTML = t.when + Math.abs(t.days);
...
var deadline = new Date(Date.parse(new Date("July 9 2017 23:59:59 GMT+0100")));
